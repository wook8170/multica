...
import { ContentEditor, type ContentEditorRef, useFileDropZone, FileDropOverlay } from "@multica/views/editor";
...
export function WikiCommentInput({ wikiId, onSubmit }: WikiCommentInputProps) {
  ...
  return (
    ...
    >
      ...
      {isDragOver && <FileDropOverlay className="-inset-1 rounded-xl" />}
    </div>
  );
}
